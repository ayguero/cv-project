                                ...
                                <div class="row">
                                    <div class="input-group-append col-xs-12 col-8 d-block ">
                                        <div class="d-flex mt-4">
                                            <button id="portfolioImage" data-input="thumbnail"
                                                    data-preview="holder"
                                                    class="file-upload-browse btn btn-info " type="button">Yükle</button>
                                            <input type="text" id="thumbnail" name="image" class="form-control file-upload-info"
                                                   placeholder="Portfolyo Resmi Yükle" value="{{ isset($portfolio) ? $portfolio->image : "" }}">
                                        </div>

                                    </div>
                                    <div class="col-4 ">
                                        <img class="img-lg" id="image" src="{{ isset($portfolio) ? $portfolio->image : "" }}" alt="Portfolio image">
                                    </div>

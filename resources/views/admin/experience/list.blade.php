                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr id="{{ $item->id }}">
                                ...
                                <td>
                                    <span data-bs-container="body" data-toggle="tooltip" data-placement="top" title="{{ substr( $item->description , 0, 200) }}">
                                ...
                                <td>
                                    @if($item->active)
                                        <a data-id="{{ $item->id }}" href="javascript:void(0)" class="btn btn-success btnChangeActive">Aktif</a>
                                    @else
                                        <a data-id="{{ $item->id }}" href="javascript:void(0)" class="btn btn-danger btnChangeActive">Pasif</a>
                                    @endif
                                </td>
                                <td> {{ $item->order }} </td>
                                <td>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.btnDelete').click(function () {
                ...
                Swal.fire({
                    title: 'Bu çalIşma bilgilerini silmek istediğinize emin misiniz?',
                    showDenyButton: true,
                    showCancelButton: true,
                    confirmButtonText: 'Evet',
                    denyButtonText: `Hayır`,
